...
class ValrExchange(ExchangeBase):
    ...
    UPDATE_BALANCES_MIN_INTERVAL = 10.0
    ...
    async def _process_trade_message(self, trade_msg: Dict[str, Any]):
        ...
        self.trigger_event(
            ...
            OrderFilledEvent(
                ...
                #     tracked_order.trade_type,
                #     tracked_order.order_type,
                #     Decimal(trade_msg["price"]),
                #     Decimal(trade_msg["quantity"])
                # ),
    ...
    async def _user_stream_event_listener(self):
        ...
        async for event_message in self._iter_user_event_queue():
            try:
                ...
                if "NEW_ACCOUNT_TRADE" in event_type:
                    trade_msg = event_message["data"]
                    await self._process_trade_message(trade_msg)

                if "ORDER_STATUS_UPDATE" in event_type:
