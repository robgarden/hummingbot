...
ValrOrderBookTrackingDictionary = Dict[Decimal, Dict[str, Dict[str, any]]]

cdef class ValrActiveOrderTracker:
    def __init__(self,
                 active_asks: ValrOrderBookTrackingDictionary = None,
                 active_bids: ValrOrderBookTrackingDictionary = None):
        super().__init__()
    ...
    @property
    def active_asks(self) -> ValrOrderBookTrackingDictionary:
        return self._active_asks

    @property
    def active_bids(self) -> ValrOrderBookTrackingDictionary:
