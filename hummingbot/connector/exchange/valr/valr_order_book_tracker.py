...
class ValrOrderBookTracker(OrderBookTracker):
    ...
    async def _track_single_book(self, trading_pair: str):
        ...
        while True:
            try:
                message: ValrOrderBookMessage = None
                saved_messages: Deque[ValrOrderBookMessage] = self._saved_message_queues[trading_pair]
                ...
                if message.type is OrderBookMessageType.DIFF:
                    ...
                    past_diffs: List[ValrOrderBookMessage] = list(past_diffs_window)
